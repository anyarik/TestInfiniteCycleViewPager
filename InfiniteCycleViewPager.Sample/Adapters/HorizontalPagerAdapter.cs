...
namespace InfiniteCycleViewPager.Sample.Adapters
{
    public class HorizontalPagerAdapter : PagerAdapter
    {
        ...
        public override Java.Lang.Object InstantiateItem(ViewGroup container, int position)
        {
            //if (position == 0)
            //{
            //    horizontalPagerFragment.backgroundView.Background = horizontalPagerFragment.Resources.GetDrawable(Resource.Drawable.background_one);
            //}
            //else if (position == 1)
            //{
            //    horizontalPagerFragment.backgroundView.Background = horizontalPagerFragment.Resources.GetDrawable(Resource.Drawable.background_two);
            //}
            //else if (position == 2)
            //{
            //    horizontalPagerFragment.backgroundView.Background = horizontalPagerFragment.Resources.GetDrawable(Resource.Drawable.background_three);
            //}
