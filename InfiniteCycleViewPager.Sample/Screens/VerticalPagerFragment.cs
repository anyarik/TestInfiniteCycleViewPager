...
namespace InfiniteCycleViewPager.Sample.Screens
{
    public class VerticalPagerFragment : Fragment
    {
        ...
        public override void OnViewCreated(Android.Views.View view, Android.OS.Bundle savedInstanceState)
        {
            ...
            verticalInfiniteCycleViewPager.LayoutChange += VerticalInfiniteCycleViewPager_LayoutChange;
        ...
        private void VerticalInfiniteCycleViewPager_LayoutChange(object sender, Android.Views.View.LayoutChangeEventArgs e)
        {
